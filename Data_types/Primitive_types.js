...
//THESE ARE IMMUTABLE => THEY CAN NEVER BE CHANGED ONLY REPLACED.
/*let str = "Hello";
...
//NUMBER METHODS
const num = 123.577;
console.log(num.toFixed(0)); // rounds to 2 decimal
console.log(num.toPrecision(4)); //4 significant digits
console.log(Number("42"));
console.log(parseInt("42.2px")); // only pases integer values
console.log(parseFloat(3.14));
console.log(isNaN(NaN));
console.log(isFinite(NaN));  //check if finite number
...
//STRING COERCION -- WHEN WE USE + WITH STRING IT CONVERT EVERYTHING INTO A STRING.
console.log("heelo" + 42);
...
console.log(Boolean("heelo")); // true;
...
if(0){
    console.log("wont't run cause its falsein Boolean");
}
...
console.log(null == undefined) // true, (cause null and undefined both gives false when converted to Boolean)
